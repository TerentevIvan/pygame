...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, dtime):
        ...
        self.rect.center += self.direction * self.speed * dtime
...
class Meteor(pygame.sprite.Sprite):
    ...
    def update(self, dtime):
        ...
        if pygame.time.get_ticks() - self.start_time >= self.lifetime:
            self.kill()
        self.rotation += self.rotation_speed * dtime
...
explosion_frames = [pygame.image.load(join(
    '5games-main', 'space shooter', 'images', 'explosion', f'{i}.png')).convert_alpha() for i in range(21)]
