...
class Game:
    ...
    def load_images(self):
        ...
        self.my_map = load_pygame(join('..', 'data', 'maps', 'world.tmx'))
    ...
    def setup(self):
        for x, y, image in self.my_map.get_layer_by_name('Ground').tiles():
            Sprite((x * TILE_SIZE, y * TILE_SIZE), image, self.all_sprites)
        for obj in self.my_map.get_layer_by_name('Objects'):
            CollisionSprite((obj.x, obj.y), obj.image, (self.all_sprites, self.collision_sprites))
        for obj in self.my_map.get_layer_by_name('Collisions'):
            CollisionSprite((obj.x, obj.y), pygame.Surface((obj.width, obj.height)), self.collision_sprites)

        for obj in self.my_map.get_layer_by_name('Entities'):
            if obj.name == 'Player':
