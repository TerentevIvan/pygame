...
class Game:
    def __init__(self):
        ...
        self.player_monsers = [Monster(name, self.back_surfs[name]) for name in player_monster_list]
        self.monster = self.player_monsers[0]
        ...
        # ui
        self.ui = UI(self.monster, self.player_monsers, self.simple_surfs, self.get_input)
    ...
    def player_turn(self):
        ...
        if self.monster.health <= 0:
            available_monsters = [monster for monster in self.player_monsers if monster.health > 0]
